...
let favoriteSong = "The man who sold the world";
...
let favoriteThing = "Skateboard";
console.log(typeof favoriteThing);

// You heard a new song that became your favorite.
// Reassign the variable "favoriteSong"
favoriteSong = "Sheena is a Punk Rocker";
...
console.log("Hello, my name is " + name + " and I like the song " + favoriteSong + ".");
